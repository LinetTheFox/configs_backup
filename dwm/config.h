...
static const char *fonts[]          = { 
		...
		"MesloLGS NF:size=9:antialias=true",
	};
static const char dmenufont[]       = "fontawesome:size=9:antialias=true";
//background color
...
static const char col_cyan[]        = "#1d2b7b";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_cyan,  col_cyan  },
        [SchemeStatus]  = { col_gray3, "#060A29",  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
        [SchemeTagsSel]  = { col_gray4, "#253BE0",  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
	[SchemeTagsNorm]  = { col_gray3, "#0A1145",  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
	[SchemeInfoSel]  = { col_gray4, col_cyan,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
	[SchemeInfoNorm]  = { col_gray3, "#060A29",  "#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
